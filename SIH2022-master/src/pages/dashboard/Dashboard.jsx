...
//                                     <button className="searchBtn btn inline-block px-6 py-2 text-red-600 font-medium text-sm leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 cursor-pointer focus:outline-none focus:ring-0 transition duration-150 ease-in-out" type="button" id="button-addon3">Search</button>
//                             </div>
//                         </div>
//                     </div>
//                     <div className='flex mb-10 justify-around'>
//                         <div className="flex w-[240px] h-[40px] items-center border-2 rounded-lg border-[#4F4F4F] px-1">
//                             <i className="text-[#4F4F4F] pl-4 pr-2 fa-solid fa-location-dot"></i>
...
//                         <div className='w-1/4'>
//                             <div className='bg-[#4F4F4F] py-4 px-1 prFilter'>
//                                 <h1 className='text-lg font-bold text-center text-white'>Product Filters</h1>
//                             </div>

//                             <div className='border py-6'>
//                                 <span className='text-lg mb-4 font-semibold text-[#4F4F4F] border-b-2 border-[#4F4F4F] pb-1 ml-6'>Categories:</span>
...
//                                 <span className='text-lg mb-4 font-semibold text-[#4F4F4F] border-b-2 border-[#4F4F4F] pb-1 ml-6'>Brands</span>
...
//                                 <span className='text-lg mb-4 font-semibold text-[#4F4F4F] border-b-2 border-[#4F4F4F] pb-1 ml-6'>Price Range</span>
...
//                                         className="rangeInput form-range text-red-100 appearance-none w-full h-6 p-0 bg-transparent focus:outline-none focus:ring-0 focus:shadow-none"
//                                     />
...
//                                 <span className='text-lg mb-4 font-semibold text-[#4F4F4F] border-b-2 border-[#4F4F4F] pb-1 ml-6'>Availability Date</span>

//                                 <p className='text-md pt-2 font-normal text-[#4F4F4F] pl-6'>From</p>

//                                 <div className='flex justify-center items-center'>
//                                     <button onClick={() => setVisible1(!visible1)} className="bg-darkred hover:bg-red-700 text-white font-normal text-sm py-1 text-center w-1/2 my-4 px-2 rounded">
//                                         DD-MM-YYYY
//                                     </button>
//                                     <i className="ml-4 text-lg text-[#4F4F4F] fa-solid fa-calendar"></i>
//                                 </div>
...
//                                 <div className='flex justify-center items-center'>
//                                     <button onClick={() => setVisible2(!visible2)} className="bg-darkred hover:bg-red-700 text-white font-normal text-sm py-1 text-center w-1/2 my-4 px-2 rounded">
//                                         DD-MM-YYYY
//                                     </button>
//                                     <i className="ml-4 text-lg text-[#4F4F4F] fa-solid fa-calendar"></i>
//                                 </div>
...
//                                 <div className='bg-[#4F4F4F] -mt-5 py-4 ml-10 px-1 prFilter'>
...
//                                 <button className="absolute top-0 right-10 shadow-md bg-darkred mx-auto hover:bg-red-700 text-white text-md font-normal py-1.5 px-3 rounded">
...
//                                 <a className='absolute top-0 right-10 mx-auto hover:bg-red-700 text-red-600 text-sm font-normal'>View All</a>
//                             </div>
                    ...
                    <div className='flex justify-around'>
                        ...
                        <div className=''>
                            <div className="input-group relative flex items-center w-full mb-4">
                                <i onClick={SpeechRecognition.startListening} className="text-darkred tooltip cursor-pointer text-2xl mr-5 fa-solid fa-microphone"><span className="tooltiptext">Search by Voice</span></i>
                    ...
                    <div className='flex justify-around w-full'>
                        <div className='w-1/4'>
                            ...
                            <div className='border py-6'>
                                ...
                                <div className='flex justify-center items-center'>
                                    <button onClick={() => setVisible1(!visible1)} className="bg-darkred text-red-700 hover:bg-red-700 text-white font-normal text-sm py-1 text-center w-1/2 my-4 px-2 rounded">
                                        DD-MM-YYYY
                                    </button>
                                    <i className="ml-4 text-lg text-[#4F4F4F] fa-solid fa-calendar"></i>
                                </div>
                                ...
                                <p className='text-md font-normal text-[#4F4F4F] pl-6'>To</p>
                                <div className='flex justify-center items-center'>
                                    <button onClick={() => setVisible2(!visible2)} className="bg-darkred text-red-700 hover:bg-red-700 text-white font-normal text-sm py-1 text-center w-1/2 my-4 px-2 rounded">
                                        DD-MM-YYYY
                                    </button>
                                    <i className="ml-4 text-lg text-[#4F4F4F] fa-solid fa-calendar"></i>
                                </div>
                        ...
                        <div className='w-3/4 ml-8'>
                            <div className='relative flex justify-around'>
                                <h1 className='absolute top-0 left-0 text-2xl font-bold text-gray-600'>Featured Products</h1>
                                <button className="absolute top-0 text-red-700  right-10 shadow-md  mx-auto hover:bg-red-700 text-white text-md font-normal py-1.5 px-3 rounded">
                                    More <i className="pl-1 w-5 fa-solid fa-angle-right"></i>
                                </button>
                            </div>
